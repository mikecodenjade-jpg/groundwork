  ...
  return (
    ...
    >
      <div className="max-w-3xl w-full mx-auto flex flex-col gap-6 pb-28">
        ...
        {/* Cooler Prep link */}
        <Link
          href="/dashboard/fuel/cooler"
          className="flex items-center gap-4 px-5 py-4 transition-all duration-150 active:scale-[0.98] hover:opacity-80"
          style={{
            backgroundColor: "#161616",
            border: "1px solid #252525",
            borderRadius: 12,
        ...
        >
          ...
          <svg viewBox="0 0 24 24" fill="none" width={16} height={16} stroke="#374151" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
            <path d="M9 6l6 6-6 6" />
          </svg>
        </Link>
      </div>
