            ...
            <div className="px-8 py-7 flex flex-col gap-6">
              <div className="flex gap-5">
                ...
                <p className="text-base leading-relaxed" style={{ color: "#E8E2D8", fontFamily: "var(--font-inter)" }}>
                  ...
                  <span style={{ color: "#9A9A9A" }}>Listen.</span>
                </p>
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  backgroundColor: completed ? "#161616" : "#C45B28",
              ...
              {completed && (
                ...
                >
                  Sign up to track your daily challenges →
                </Link>
              )}
            </div>
          </section>
            ...
            <div className="flex flex-col gap-4">
              {CREW_SCRIPTS.map((script) => (
                <ScriptCard
                  ...
                  onToggle={() =>
                    setOpenScript(openScript === script.title ? null : script.title)
                  }
                />
              ))}
            </div>
          ...
          <section>
            ...
            <div style={{ backgroundColor: "#161616", border: "1px solid #252525", borderRadius: "12px" }}>
              ...
              <div className="px-8 py-7 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-3 pt-2">
                  {[
                    ...
                    <div key={prompt} className="flex gap-4 items-start">
                      ...
                      <p className="text-sm font-semibold" style={{ color: "#9A9A9A", fontFamily: "var(--font-inter)" }}>
                        {prompt}
                      </p>
                    </div>
                  ))}
                ...
                <p className="text-sm leading-relaxed pt-2" style={{ color: "#9A9A9A", fontFamily: "var(--font-inter)" }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${isOpen ? "#C45B28" : "#252525"}`,
        borderRadius: "12px",
      }}
    >
      <button
      ...
      {isOpen && (
        <div className="px-8 pb-7 flex flex-col gap-3" style={{ borderTop: "1px solid #252525" }}>
          <p
          ...
          {script.map((line, i) => (
            <div key={i} className="flex gap-4 items-start">
              ...
              <p className="text-sm leading-relaxed italic" style={{ color: "#9A9A9A", fontFamily: "var(--font-inter)" }}>
                {line}
              </p>
            </div>
          ))}
