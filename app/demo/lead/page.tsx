                ...
                <div className="flex flex-col gap-3 pt-2">
                  {[
                    ...
                    <div key={prompt} className="flex gap-4 items-start">
                      ...
                      <p className="text-sm font-semibold" style={{ color: "#A09890" }}>
                        {prompt}
                      </p>
                    </div>
                  ))}
...
function ScriptCard({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="px-8 pb-7 flex flex-col gap-3" style={{ borderTop: "1px solid #1A1A1A" }}>
          <p
          ...
          {script.map((line, i) => (
            <div key={i} className="flex gap-4 items-start">
              ...
              <p className="text-sm leading-relaxed italic" style={{ color: "#A09890" }}>
                {line}
              </p>
            </div>
          ))}
